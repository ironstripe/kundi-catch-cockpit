...
const CATCH_SELECT = `
  ...
  delivery_included, regular_price, catch_price, vat_rate,
  purchase_price_includes_vat, purchase_vat_rate, delivery_cost_includes_vat,
  delivery_vat_rate, vat_basis_confirmed, available_from, available_until,
...
function catchRow(row: any) {
  ...
  const planned = calculateCatch(input).values;
  ...
  return {
    ...
    vat_rate: values?.vat_rate ?? planned?.vat_rate ?? null,
    purchase_price_basis: input.purchase_price_includes_vat ? "inkl. MWST" : "exkl. MWST",
    purchase_vat_rate: planned?.purchase_vat_rate ?? null,
    net_purchase_price: planned?.net_purchase_price_per_unit ?? null,
    delivery_cost_basis: input.delivery_cost_includes_vat ? "inkl. MWST" : "exkl. MWST",
    delivery_vat_rate: planned?.delivery_vat_rate ?? null,
    net_delivery_cost: planned?.net_delivery_cost ?? null,
    net_investment: planned?.net_investment ?? null,
    vat_basis_confirmed: row.vat_basis_confirmed ? "ja" : "nein",
    maximum_gross_revenue: planned?.maximum_gross_revenue ?? null,
    maximum_net_revenue: planned?.maximum_net_revenue ?? null,
    maximum_sales_vat: planned?.maximum_sales_vat ?? null,
    maximum_margin: planned?.maximum_contribution_margin ?? null,
    internal_handling_cost_per_unit: planned?.internal_handling_cost_per_unit ?? null,
    internal_handling_cost_total: planned?.internal_handling_cost_total ?? null,
    planned_db_ii: planned?.db_ii ?? null,
    planned_db_ii_margin: planned?.db_ii_margin_percentage ?? null,
    ...
    effective_db_ii: values?.db_ii ?? null,
    effective_db_ii_margin: values?.db_ii_margin_percentage ?? null,
...
const CATCH_COLUMNS: Column[] = [
  ...
  { header: "Einkaufspreis wie erfasst", key: "purchase_price", width: 20, numFmt: CHF },
  { header: "Steuerbasis Einkaufspreis", key: "purchase_price_basis", width: 20 },
  { header: "MWST-Satz Einkauf", key: "purchase_vat_rate", width: 16, numFmt: PERCENT },
  { header: "Nettoeinkaufspreis", key: "net_purchase_price", width: 18, numFmt: CHF },
  { header: "Lieferkosten wie erfasst", key: "delivery_cost", width: 20, numFmt: CHF },
  { header: "Steuerbasis Lieferkosten", key: "delivery_cost_basis", width: 20 },
  { header: "MWST-Satz Lieferkosten", key: "delivery_vat_rate", width: 18, numFmt: PERCENT },
  { header: "Nettolieferkosten", key: "net_delivery_cost", width: 18, numFmt: CHF },
  { header: "Steuerbasis bestätigt", key: "vat_basis_confirmed", width: 18 },
  { header: "Nettoinvestition", key: "net_investment", width: 18, numFmt: CHF },
  { header: "Normalpreis inkl. MWST", key: "regular_price", width: 20, numFmt: CHF },
  { header: "Food-Catch-Preis inkl. MWST", key: "catch_price", width: 22, numFmt: CHF },
  { header: "Max. Bruttoumsatz", key: "maximum_gross_revenue", width: 18, numFmt: CHF },
  { header: "Max. Nettoumsatz", key: "maximum_net_revenue", width: 18, numFmt: CHF },
  { header: "Max. MWST", key: "maximum_sales_vat", width: 14, numFmt: CHF },
  { header: "Max. DB netto (DB I)", key: "maximum_margin", width: 18, numFmt: CHF },
  {
    header: "Interner Aufwand pro Einheit",
    key: "internal_handling_cost_per_unit",
    width: 22,
    numFmt: CHF,
  },
  { header: "Interner Aufwand total", key: "internal_handling_cost_total", width: 20, numFmt: CHF },
  { header: "Geplanter DB II", key: "planned_db_ii", width: 16, numFmt: CHF },
  { header: "Geplante DB-II-Marge", key: "planned_db_ii_margin", width: 20, numFmt: PERCENT },
  ...
  { header: "MWST-Satz Verkauf", key: "vat_rate", width: 16, numFmt: PERCENT },
  { header: "Effektiver Nettoumsatz", key: "effective_revenue", width: 20, numFmt: CHF },
  { header: "Effektiver Bruttoumsatz", key: "effective_revenue_gross", width: 20, numFmt: CHF },
  { header: "Effektive MWST", key: "effective_vat", width: 16, numFmt: CHF },
  { header: "Effektiver DB netto (DB I)", key: "effective_margin", width: 20, numFmt: CHF },
  { header: "Effektiver DB II", key: "effective_db_ii", width: 16, numFmt: CHF },
  { header: "Effektive DB-II-Marge", key: "effective_db_ii_margin", width: 20, numFmt: PERCENT },
